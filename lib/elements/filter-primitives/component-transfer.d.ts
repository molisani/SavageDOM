...
declare type TransferFunction_Elements = SVGFEFuncRElement | SVGFEFuncGElement | SVGFEFuncBElement | SVGFEFuncAElement;
export declare type TransferFunction_Attributes = IdentityFunction_Attributes | TabularFunction_Attributes | LinearFunction_Attributes | GammaFunction_Attributes;
export declare class TransferFunction_Primitive extends Element<TransferFunction_Elements, TransferFunction_Attributes> {
...
export declare class ComponentTransfer_Primitive extends FilterPrimitive<SVGFEComponentTransferElement, ComponentTransfer_Attributes> {
