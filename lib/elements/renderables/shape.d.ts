...
export declare abstract class AbstractShape<ELEMENT extends SVGGraphicsElement, ATTRIBUTES extends Shape_Attributes = Shape_Attributes> extends AbstractRenderable<ELEMENT, ATTRIBUTES> {
}
